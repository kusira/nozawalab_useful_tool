...
If Not fso.FileExists(mainPy) Then
    MsgBox "main.py が見つかりません。" & vbCrLf & mainPy, vbCritical, "image_analyzer"
    WScript.Quit 1
End If
...
MsgBox "Python が見つかりません。" & vbCrLf & vbCrLf & "Python 3.10 以上をインストールし、PATH に追加してください。", vbCritical, "image_analyzer"
WScript.Quit 1